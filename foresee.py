...
factors = {'AT1': ['0.01', '0.1', '10', '100'], 'AT3': ['0.001', '0.01', '0.1', '10'], 'AT4': ['0.01', '0.1', '10', '100'], 'AT9': ['0.1', '10', '100', '1000'], 'AT15':['0.00001', '0.0001', '0.001', '0.01'], 'AFC3':['0.0001', '0.001', '0.01', '0.1']}
...
def conf_gen(home, rq, time_str, specID, algo, trials, fac = 1, c = 0.2, bp = 10):
	...
	if rq == 1:
		...
		if specID.startswith('AT'):
			...
			model = 'fuel_control_' + rescaled_signals[specID] + '_' + scales[fac]
			basic_file = home + '/test/conf/AFC_basic'
...
if __name__ == "__main__":
	...
	if len(sys.argv) == 1 or sys.argv[1] == 'RQ1':
		...
		print('Please specify the number of trials,\ne.g., 10')
		trials = int(input())
		conf_gen(home, 3, ts, specID, algo, trials, c = float(c), bp = int(bp))
	else:
		print('Please try again')
